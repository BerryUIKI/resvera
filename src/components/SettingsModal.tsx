...
export const SettingsModal: Component<SettingsModalProps> = (props) => {
  ...
  return (
    <Show when={props.isOpen}>
      ...
      >
        <div class="w-full max-w-md bg-slate-900 border border-slate-800 rounded-xl p-6 shadow-2xl space-y-5 select-none animate-in fade-in zoom-in-95 duration-150">
          ...
          <div class="space-y-4 text-xs text-slate-300">
            ...
            <div class="bg-slate-800/60 p-3 rounded-lg border border-slate-700/50 text-[11px] text-slate-400">
