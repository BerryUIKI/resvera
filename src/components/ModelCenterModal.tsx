...
export const ModelCenterModal: Component<ModelCenterModalProps> = (props) => {
  ...
  return (
    <Show when={props.isOpen}>
      ...
      >
        <div class="w-full max-w-2xl bg-slate-900 border border-slate-800 rounded-xl p-6 shadow-2xl space-y-5 select-none max-h-[85vh] flex flex-col animate-in fade-in zoom-in-95 duration-150">
