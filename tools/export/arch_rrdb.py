"""
RRDBNet Architecture Definition
Matches the official Real-ESRGAN implementation (xinntao/Real-ESRGAN / BasicSR).
"""
...
class RRDBNet(nn.Module):
    ...
    Args:
        ...
        num_block (int): Block number in the trunk network. Default: 23 (RealESRGAN_x4plus), 6 (RealESRGAN_x4plus_anime_6B).
